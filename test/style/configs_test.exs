...
defmodule Styler.Style.ConfigsTest do
  ...
  test "issue #244: phx.new config.exs comments survive sorting" do
    assert_style(
      ...
      config :phx_new, PhxNewWeb.Endpoint,
        ...
        live_view: [signing_salt: "QdK6mkm/"]
      ...
      config :phx_new, PhxNew.Mailer, adapter: Swoosh.Adapters.Local
  ...
  test "issue #244: phx.new prod.exs trailing/dangling comments survive sorting" do
    assert_style(
      ...
      config :phx_new, PhxNewWeb.Endpoint, cache_static_manifest: "priv/static/cache_manifest.json"
